<template lang="pug">
    b-row.m-0.p-0.pt-5( style="background: #1C2B3F" )
        ...
        b-col.mx-auto.mt-xl-5.p-1.d-flex.justify-content-center.align-items-center.min-vh-100( :style="isMobile ? 'background: #1C2B3F' : 'background: #fff'" cols="12" xl="8" v-else  )
            pdf-viewer( :src="sourceLink" :scale.sync="scale" style="width:100%;" )
